...
class MallasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create malla" do
    assert_difference('Malla.count') do
      post mallas_url, params: { malla: { caracteristica: @malla.caracteristica, estado: @malla.estado, num_malla: @malla.num_malla } }
    end
  ...
  test "should update malla" do
    patch malla_url(@malla), params: { malla: { caracteristica: @malla.caracteristica, estado: @malla.estado, num_malla: @malla.num_malla } }
